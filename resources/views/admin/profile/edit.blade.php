...
<div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
    <div class="px-4 py-6 sm:px-0">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-semibold text-gray-900">Edit Profile: {{ $profile->name }}</h1>
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
            <form action="{{ route('admin.profile.update', $profile) }}" method="POST" enctype="multipart/form-data" class="p-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="col-span-1 md:col-span-2">
                        ...
                        <textarea name="bio" id="bio" rows="4"
                            class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">{{ old('bio', $profile->bio) }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="url" name="resume_link" id="resume_link" value="{{ old('resume_link', $profile->resume_link) }}"
                            class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="url" name="instagram" id="instagram" value="{{ old('instagram', $profile->instagram) }}"
                            class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                    </div>
                    ...
                    <div class="col-span-1 md:col-span-2">
                        ...
                        <div class="mt-1 flex items-center">
                            @if($profile->avatar)
                                <img class="h-12 w-12 rounded-full object-cover" src="{{ Storage::url($profile->avatar) }}" alt="{{ $profile->name }}">
                            @else
