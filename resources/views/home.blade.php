...
<body class="font-sans antialiased">
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
                ...
                <div class="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition">
                    ...
                    <p class="text-gray-600">Building websites that look great on all devices, from desktop to mobile.</p>
                </div>
    ...
    <section id="skills" class="py-20 bg-gray-50">
        <div class="container mx-auto px-4">
            <div class="text-center mb-12">
                ...
                <div class="w-20 h-1 bg-blue-500 mx-auto mb-6"></div>
                <p class="text-gray-600 max-w-2xl mx-auto">Here are some of the technologies and skills I've worked with.</p>
            </div>

            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6">
                @forelse($skills as $skill)
                    <div class="flex flex-col items-center bg-white shadow-md rounded-lg p-6 transition-transform hover:transform hover:scale-105">
                        @if($skill->icon)
                            <div class="mb-4">
                                <img src="{{ Storage::url($skill->icon) }}" alt="{{ $skill->name }}" class="w-16 h-16 object-contain">
                            </div>
                        @endif
        ...
        <div class="container mx-auto px-4">
                            ...
                            <div class="p-6">
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    @if($project->project_url)
                                        <a href="{{ $project->project_url }}" target="_blank" class="text-blue-500 hover:text-blue-700">
            ...
            @if(count($projects) > 6)
                ...
                <div class="text-center mt-12">
                    <button id="show-more-btn" class="px-6 py-3 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors duration-300 flex items-center mx-auto">
                        <span id="button-text">Show More Projects</span>
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" id="button-icon">
        ...
        <section id="education" class="py-20 bg-gradient-to-br from-white to-blue-50 relative overflow-hidden">
            ...
            <div class="absolute inset-0 overflow-hidden">
                <div class="education-shapes opacity-20">
                    ...
                    <div class="absolute w-96 h-96 rounded-full bg-indigo-400 blur-3xl bottom-0 -right-20 animate-pulse" style="animation-delay: 2s;"></div>
                    <div class="absolute w-64 h-64 rounded-full bg-cyan-400 blur-3xl top-1/3 right-1/4 animate-pulse" style="animation-delay: 3s;"></div>
                </div>
            </div>

            <div class="container mx-auto px-4 relative z-10">
                <div class="text-center mb-16">
                    <h2 class="text-4xl font-bold mb-4 bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">Education</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                    @forelse($educations as $education)
                        <div class="group bg-white p-8 rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-blue-200 transform hover:-translate-y-1">
                            <div class="flex items-start mb-5">
                                @if($education->institution_logo)
                                    <div class="mr-5">
                                        <div class="h-16 w-16 rounded-lg bg-white shadow-sm p-2 flex items-center justify-center overflow-hidden">
                                            <img src="{{ asset('storage/' . $education->institution_logo) }}" alt="{{ $education->institution }}" class="h-12 w-12 object-contain">
                                        </div>
                                    </div>
                                @else
                                    <div class="mr-5">
                                        <div class="h-16 w-16 rounded-lg bg-gradient-to-br from-blue-500 to-indigo-600 text-white flex items-center justify-center">
                                            <i class="fas fa-graduation-cap text-2xl"></i>
                                        </div>
                                    </div>
                                @endif
                                <div>
                                    <h3 class="text-xl font-bold text-gray-800 group-hover:text-blue-600 transition-colors">{{ $education->degree }}</h3>
    ...
    <section id="testimonials" class="py-24 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
        ...
        <div class="container mx-auto px-4 relative z-10">
            <div class="text-center mb-16">
                <h2 class="text-4xl font-bold mb-4 bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">Comment</h2>
                <div class="w-24 h-1 bg-gradient-to-r from-blue-500 to-indigo-500 mx-auto mb-8 rounded-full"></div>
            ...
            <div class="relative max-w-6xl mx-auto px-4 overflow-hidden" id="testimonials-container">
                ...
                <div class="testimonials-track flex transition-transform duration-500 ease-out">
                    @forelse($testimonials as $testimonial)
                        <div class="testimonial-slide w-full md:w-1/3 flex-shrink-0 px-4">
                            <div class="bg-white rounded-2xl shadow-lg overflow-hidden h-full transform transition-all duration-300 hover:shadow-xl hover:-translate-y-1 flex flex-col">
                                <div class="absolute top-0 right-0 w-32 h-32 -mt-12 -mr-12 bg-gradient-to-br from-blue-400 to-indigo-500 opacity-10 rounded-full"></div>
                                ...
                                <div class="p-8 relative flex flex-col h-full">
                                    ...
                                    <div class="text-yellow-400 mb-6 flex">
                                        @for($i = 0; $i < 5; $i++)
                                            @if($i < $testimonial->rating)
                                                <svg class="w-5 h-5 mr-1" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                                    <path d="M12 .587l3.668 7.568 8.332 1.151-6.064 5.828 1.48 8.279-7.416-3.967-7.417 3.967 1.481-8.279-6.064-5.828 8.332-1.151z"/>
                                                </svg>
                                            @else
                                                <svg class="w-5 h-5 mr-1 text-yellow-200" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                                    <path d="M12 .587l3.668 7.568 8.332 1.151-6.064 5.828 1.48 8.279-7.416-3.967-7.417 3.967 1.481-8.279-6.064-5.828 8.332-1.151z"/>
                                                </svg>
                                            @endif
                                        @endfor
                                    ...
                                    <div class="mt-auto pt-6 border-t border-gray-100 flex items-center">
                                        @if($testimonial->avatar)
                                            <img src="{{ asset('storage/' . $testimonial->avatar) }}" alt="{{ $testimonial->name }}" class="w-14 h-14 rounded-full object-cover border-2 border-blue-100">
                                        @else
                                            <div class="w-14 h-14 rounded-full bg-gradient-to-br from-blue-400 to-indigo-500 flex items-center justify-center text-white">
                                                <span class="text-lg font-bold">{{ substr($testimonial->name, 0, 1) }}</span>
                                            </div>
                                        @endif
                ...
                <button class="absolute top-1/2 -left-4 transform -translate-y-1/2 bg-white rounded-full shadow-lg p-3 focus:outline-none hover:bg-blue-50 transition-colors hidden md:block" id="prev-btn">
                    <svg class="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path>
                    </svg>
                </button>
                <button class="absolute top-1/2 -right-4 transform -translate-y-1/2 bg-white rounded-full shadow-lg p-3 focus:outline-none hover:bg-blue-50 transition-colors hidden md:block" id="next-btn">
                    <svg class="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    <section id="contact" class="py-24 bg-gradient-to-b from-white to-blue-50 relative overflow-hidden">
        ...
        <div class="absolute inset-0 overflow-hidden">
            ...
            <div class="contact-waves">
                ...
                <div class="absolute bottom-0 left-0 right-0 h-32 bg-blue-50 opacity-10" style="clip-path: polygon(0% 100%, 100% 100%, 100% 40%, 70% 50%, 40% 40%, 20% 50%, 0% 40%);"></div>
            </div>
        </div>
        ...
        <div class="container mx-auto px-4 max-w-6xl relative z-10">
            <div class="text-center mb-16">
                ...
                <p class="text-gray-600 max-w-2xl mx-auto text-lg">Feel free to contact me for any work or suggestions.</p>
            </div>
                    ...
                    <div class="bg-white p-10 rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition duration-300">
                        ...
                        <div class="mt-10">
                            ...
                            <div class="flex space-x-4 justify-center">
                                <a href="https://www.linkedin.com/in/ilham-saputra26/" target="_blank" class="bg-white text-blue-500 hover:bg-blue-500 hover:text-white border border-blue-500 transition duration-300 p-3 rounded-lg shadow-sm">
                                    <i class="fab fa-linkedin-in text-lg"></i>
                                </a>

                                <a href="https://github.com/ISHASII" target="_blank" class="bg-white text-blue-500 hover:bg-blue-500 hover:text-white border border-blue-500 transition duration-300 p-3 rounded-lg shadow-sm">
                                    <i class="fab fa-github text-lg"></i>
                                </a>

                                <a href="https://www.instagram.com/ishasi__/" target="_blank" class="bg-white text-blue-500 hover:bg-blue-500 hover:text-white border border-blue-500 transition duration-300 p-3 rounded-lg shadow-sm">
                    ...
                    <div class="bg-white p-10 rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition duration-300">
                        ...
                        <form action="https://formspree.io/f/movejbya" method="POST" class="space-y-6">
                            <div>
                                ...
                                <input type="text" id="name" name="name" class="w-full px-5 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-300" required placeholder="Enter your name">
                            </div>

                            <div>
                                <label for="email" class="block text-gray-700 font-medium mb-2">Your Email</label>
                                <input type="email" id="email" name="email" class="w-full px-5 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-300" required placeholder="Enter your email">
                            </div>

                            <div>
                                <label for="subject" class="block text-gray-700 font-medium mb-2">Subject</label>
                                <input type="text" id="subject" name="subject" class="w-full px-5 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-300" required placeholder="Enter subject">
                            </div>

                            <div>
                                <label for="message" class="block text-gray-700 font-medium mb-2">Message</label>
                                <textarea id="message" name="message" rows="5" class="w-full px-5 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-300" required placeholder="Your message here..."></textarea>
                            </div>
                            ...
                            <button type="submit" class="bg-blue-500 text-white px-8 py-4 rounded-lg hover:bg-blue-600 transition duration-300 w-full font-medium text-lg shadow-md hover:shadow-lg transform hover:-translate-y-1">Send Message</button>
                        </form>
                    </div>
                </div>
            </div>
                ...
                <div class="flex flex-col md:flex-row justify-between items-center">
                    ...
                    <div class="flex space-x-4">
                        @if($profile->linkedin_url ?? false)
                            <a href="{{ $profile->linkedin_url }}" target="_blank" class="text-gray-400 hover:text-white transition">
                                <i class="fab fa-linkedin-in"></i>
                            </a>
                        @endif

                        @if($profile->github_url ?? false)
                            <a href="{{ $profile->github_url }}" target="_blank" class="text-gray-400 hover:text-white transition">
                                <i class="fab fa-github"></i>
                            </a>
                        @endif

                        @if($profile->twitter_url ?? false)
                            <a href="{{ $profile->twitter_url }}" target="_blank" class="text-gray-400 hover:text-white transition">
                                <i class="fab fa-twitter"></i>
                            </a>
                        @endif

                        @if($profile->instagram_url ?? false)
                            <a href="{{ $profile->instagram_url }}" target="_blank" class="text-gray-400 hover:text-white transition">
